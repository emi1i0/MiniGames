...
export interface Level {
  ...
  hud?: Cell; // celda sobre la que se ancla el HUD (cronometro); ausente = arriba-centro
}

/**
 * Convierte un mapa en un Level con grid limpio ('#'/'.'). Marcadores:
 *   A = origen, B = destino, t/T = ancla del HUD (t sobre corredor, T sobre pared).
 */
export function parseGrid(rows: string[]): Level {
  ...
  return { grid, cols: nCols, rows: nRows, start, end, hud };
}
